...
def codeDeploy() {
    stage('Dev Deployment') {
      ...
      cd /tmp/repo 
      sed -i  "/367241114876.dkr.ecr.us-east-1.amazonaws.com/default/\\/${service_name}/ c \\ \\ \\ \\ image: 367241114876.dkr.ecr.us-east-1.amazonaws.com/default\\/${service_name}:${TAG_NAME}" helm/chart/values.yaml
